...
{
	return pointLight.color * material.ambient;
}
...
vec3 calculateSpecular(Material material, vec3 vs_position, vec3 vs_normal, vec3 lightPos0, vec3 cameraPos)
{
	...
	//vec3 specularFinal = specularConstant;
	vec3 specularFinal = pointLight.color * material.specular * specularConstant;
